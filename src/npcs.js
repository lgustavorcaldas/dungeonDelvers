...
function addBagButton(name, id){
    $(`
    <span style="--i:${id};">
        <a href="#" title="${name}" id="${id}" onclick="bag${name}.useItem()"><i class='bx bxs-home'>
...
class Items{
    ...
    bag(){
        switch(this.name){
            case "HalfPotion":
                addBagButton("HalfPotion","1");
                $("#bottomLog")
                    .html(`<h3 id="halfPotionSteal">You Got a Heal Potion.</h3>`)
                $("#halfPotionSteal")
                    .css({"color": "white","text-shadow": "0 0 15px black"})
                $("#navIII")
                    .effect("pulsate")
            break;
            case "FullPotion":
                addBagButton("FullPotion","2");
                $("#bottomLog")
                    .html(`<h3 id="fullPotionSteal">You Got a Full Potion.</h3>`)
                $("#fullPotionSteal")
                    .css({"color": "white","text-shadow": "0 0 15px black"})
                $("#navIII")
                    .effect("pulsate")
